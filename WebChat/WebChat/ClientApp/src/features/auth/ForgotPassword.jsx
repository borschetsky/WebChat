        ...
        {sent ? (
          <>
            ...
            <Typography sx={{ fontSize: 13, color: 'text.secondary', mb: 3 }}>
              Nothing arrived? Check your spam folder, and confirm you typed the address you signed
              up with.
            </Typography>
          ...
          <>
            <Typography sx={{ color: 'text.secondary', mb: 3 }}>
              Enter the email address you signed up with and we&apos;ll send you a link to choose a
              new password.
            </Typography>
