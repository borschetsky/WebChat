...
export default function Composer({
  ...
  return (
    <Box sx={{ p: 2, pt: 1.5, bgcolor: 'background.paper', borderTop: 1, borderColor: 'divider' }}>
      {replyTo && (
        <Stack direction="row" spacing={1.25} sx={{ alignItems: 'center', mb: 1.25, px: 1.5, py: 1, borderLeft: 3, borderColor: 'primary.main', bgcolor: 'background.quote', borderRadius: '0 8px 8px 0' }}>
