  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        {m.quote && (
          <Stack direction="row" spacing={1} sx={{ alignItems: 'center', my: 0.5, px: 1.25, py: 0.5, borderLeft: 3, borderColor: 'primary.main', bgcolor: 'background.quote', borderRadius: '0 6px 6px 0', maxWidth: 520 }}>
        ...
        {m.attachment && (
          <Stack direction="row" spacing={1.25} sx={{ alignItems: 'center', mt: 1, p: 1.25, px: 1.75, border: 1, borderColor: 'divider', borderRadius: 2.5, display: 'inline-flex' }}>
